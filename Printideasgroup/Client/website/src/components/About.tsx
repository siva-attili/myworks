    ...
    <React.Fragment>
      <div className="pi-banner">
        <div className="piheader-txt">
          …
          {
            "{ one stop solution of end-to-end branding   deliberations into designs. Yes, you read it right. Any brand iundone without the branding material ensembles and that is when wcome into the p }"
          }
          …
        </div>
      </div>
